...
<style>
    ...
    .content-preview { background: rgba(252, 250, 241, 0.05); padding: 15px; border-radius: 6px; border-left: 4px solid #DEB887; margin: 10px 0; }
    ...
    .badge-item { background: rgba(222, 184, 135, 0.2); color: #CD853F; padding: 5px 10px; border-radius: 15px; margin: 5px; display: inline-block; border: 1px solid #DEB887; }
</style>
